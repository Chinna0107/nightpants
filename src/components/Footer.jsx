...
export function Footer() {
  return (
    <footer className="hidden md:block bg-gray-900 border-t-2 border-indigo-600/40 mt-12 w-full relative overflow-hidden">
      {/* Decorative Glow */}
      ...
      {/* Newsletter Section */}
      <div className="max-w-7xl mx-auto px-4 md:px-8 pt-16 pb-12 border-b border-gray-800 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 bg-gray-800 p-8 md:p-10 rounded-3xl border border-gray-700 shadow-xl">
          <div className="max-w-xl text-center md:text-left">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-3" style={{ fontFamily: 'inherit' }}>Join the VIP Club</h3>
          ...
          <div className="w-full md:w-auto flex-1 max-w-md flex items-center gap-2 relative">
            <input 
              ...
              className="w-full bg-gray-900 border border-gray-700 rounded-full py-3.5 pl-6 pr-32 text-sm text-white placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-indigo-600 transition-all"
            />
            <button className="absolute right-1.5 top-1.5 bottom-1.5 bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-500 hover:to-indigo-400 text-white font-bold px-6 rounded-full text-sm transition-all shadow-lg hover:shadow-indigo-600/30">
              Subscribe
            </button>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pt-12 pb-24 md:pb-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-12">
          ...
          <div className="flex flex-col gap-5">
            <div className="flex items-center gap-3">
              ...
              {/* <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight text-white font-sans" style={{ fontFamily: 'inherit' }}>
                Aradhana Apparels
              </h2> */}
            </div>
            ...
            <div className="flex items-center gap-3 mt-2">
              <a href="#" className="w-10 h-10 rounded-full bg-gray-800 border border-indigo-600/30 flex items-center justify-center text-indigo-600 hover:bg-indigo-600 hover:text-white transition-all hover:-translate-y-1 shadow-[0_4px_10px_rgba(255,153,0,0.1)]">
          ...
          <div className="flex flex-col gap-4">
            <h3 className="text-lg font-bold text-white mb-2 relative inline-block">
              Quick Links
              <span className="absolute -bottom-1 left-0 w-8 h-1 bg-indigo-600 rounded-full"></span>
            </h3>
            {[
              { name: 'Home', path: '/' },
              ...
              <Link key={link.name} to={link.path} className="group flex items-center text-[14px] text-gray-300 hover:text-indigo-600 transition-colors w-fit">
                <ChevronRight className="w-4 h-4 mr-1 opacity-0 -ml-5 group-hover:opacity-100 group-hover:ml-0 transition-all text-indigo-600" />
        ...
        <div className="mt-12 pt-6 border-t border-gray-800 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link to="/privacy-policy" className="text-[14px] text-gray-400 hover:text-indigo-600 transition-colors font-medium">Privacy Policy</Link>
            <Link to="/terms" className="text-[14px] text-gray-400 hover:text-indigo-600 transition-colors font-medium">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
