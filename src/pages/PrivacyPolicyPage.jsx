    ...
    <div className="bg-[#f9f9f9] min-h-screen pb-20 md:pb-0 font-sans">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 -mt-12 relative z-20 pb-24">
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 md:p-12 text-gray-700 leading-relaxed space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4 font-sans">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4 font-sans">2. Use of Your Information</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4 font-sans">3. Disclosure of Your Information</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4 font-sans">4. Contact Us</h2>
            <p>If you have questions or comments about this Privacy Policy, please contact us at:</p>
            <div className="mt-4 p-6 bg-[#f9f9f9] rounded-2xl border border-gray-100">
              <p className="font-bold text-gray-900 mb-1">Aradhana Apparels</p>
              ...
              <p className="text-indigo-600 font-medium">Email: aradhanaapparels@gmail.com</p>
            </div>
          </section>
        </div>
      </div>
